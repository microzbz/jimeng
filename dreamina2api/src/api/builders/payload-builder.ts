...
export type RegionKey = "CN" | "US" | "HK" | "JP" | "SG" | "INTL_DEFAULT";
...
function getRegionKey(regionInfo: RegionInfo): RegionKey {
  if (regionInfo.countryCode === "us") return "US";
  if (regionInfo.countryCode === "hk") return "HK";
  if (regionInfo.countryCode === "jp") return "JP";
  if (regionInfo.countryCode === "sg") return "SG";
  if (regionInfo.profileKey === "intl-default") return "INTL_DEFAULT";
  return "CN";
}
...
export function resolveResolution(
  ...
  if (userModel === "nanobanana") {
    ...
    } else if (regionKey === "HK" || regionKey === "JP" || regionKey === "SG" || regionKey === "INTL_DEFAULT") {
