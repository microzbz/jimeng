...
export const DEFAULT_VIDEO_MODEL_ASIA = "jimeng-video-seedance-2.0-fast";
...
export const VIDEO_MODEL_MAP_ASIA = {
  "jimeng-video-seedance-2.0": "dreamina_seedance_40_pro",
  "jimeng-video-seedance-2.0-fast": "dreamina_seedance_40",
  "jimeng-video-video-lab": "dreamina_unified_edit_model",
...
export function getImageModelMapBySet(modelSet: ModelSetKey) {
  switch (modelSet) {
    case "us":
      return IMAGE_MODEL_MAP_US;
    case "asia":
      return IMAGE_MODEL_MAP_ASIA;
    default:
      return IMAGE_MODEL_MAP;
  }
}

export function getVideoModelMapBySet(modelSet: ModelSetKey) {
  switch (modelSet) {
    case "us":
      return VIDEO_MODEL_MAP_US;
    case "asia":
      return VIDEO_MODEL_MAP_ASIA;
    default:
      return VIDEO_MODEL_MAP;
  }
}

export function getSupportedImageModels(modelSet: ModelSetKey): string[] {
  return Object.keys(getImageModelMapBySet(modelSet));
}

export function getSupportedVideoModels(modelSet: ModelSetKey): string[] {
  return Object.keys(getVideoModelMapBySet(modelSet));
}
